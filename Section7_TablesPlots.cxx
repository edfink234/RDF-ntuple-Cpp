...
//    11      //Z-jets
    ...
    for (int i = 0; i < 6; i++) //signal samples plus data
    {
        ...
        TH1F* errorHist = new TH1F(Form("errorHist_%d", i), "", resultmapHists[i]["nominal"].GetNbinsX(),
        ...
        errorHist->SetMarkerSize(0.8);
        errorHist->SetMarkerColor(kBlack);
        double error;
