...
//    11      //Z-jets
    ...
    pad2->Draw();
    pad2->cd();
    TLegend* errorLegend = new TLegend(0.367, 0.74, 0.567, 0.94);
    TH1F* errorHist;
    double error;
    ...
    pad2->Draw();
    pad2->cd();
    errorLegend = new TLegend(0.37, 0.7, 0.57, 0.9);
    ...
    for (int i = 0; i < 4; i++) //systematics: Z-jets
    {
        ...
        else
        {
            ...
            if (i == 1)
            {
                ...
                errorHist->GetYaxis()->SetTitleOffset(0.4);
                errorHist->GetYaxis()->CenterTitle(true);
                errorHist->SetMaximum(3.5);
                errorHist->SetMinimum(-1.3);
                errorHist->Draw("histsame");
...
//    11      //Z-jets
    ...
    pad2->Draw();
    pad2->cd();
    errorLegend = new TLegend(0.32, 0.7, 0.52, 0.9);
