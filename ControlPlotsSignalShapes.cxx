...
//    histos[0]->SetAxisRange(0., 11500,"Y");
//
...
//    histos[2]->SetAxisRange(0., 6590,"Y");
//
...
//            Nodes[i].GetResultPtr<TH1D>()->GetYaxis()->CenterTitle(true);
//            Nodes[i].GetResultPtr<TH1D>()->SetAxisRange(0., 405,"Y");
//            Nodes[i].GetResultPtr<TH1D>()->Draw("HIST");
//        }
//        else
//        {
...
//            Nodes[i].GetResultPtr<TH1D>()->GetYaxis()->CenterTitle(true);
//            Nodes[i].GetResultPtr<TH1D>()->SetAxisRange(0., 221,"Y");
//            Nodes[i].GetResultPtr<TH1D>()->Draw("HIST");
//        }
//        else
//        {
...
//            Nodes[i].GetResultPtr<TH1D>()->GetYaxis()->CenterTitle(true);
//            Nodes[i].GetResultPtr<TH1D>()->SetAxisRange(0., 189,"Y");
//            Nodes[i].GetResultPtr<TH1D>()->Draw("HIST");
//        }
//        else
//        {
...
//            Nodes[i].GetResultPtr<TH1D>()->GetYaxis()->CenterTitle(true);
//            Nodes[i].GetResultPtr<TH1D>()->SetAxisRange(0., 153,"Y");
//            Nodes[i].GetResultPtr<TH1D>()->Draw("HIST");
//        }
//        else
//        {
...
//            Nodes[i].GetResultPtr<TH1D>()->SetAxisRange(0., 2720,"Y");
//            Nodes[i].GetResultPtr<TH1D>()->Draw("HIST");
//        }
//        else
//        {
...
//            Nodes[i].GetResultPtr<TH1D>()->GetYaxis()->CenterTitle(true);
//            Nodes[i].GetResultPtr<TH1D>()->GetXaxis()->SetTitleOffset(1.2);
//            Nodes[i].GetResultPtr<TH1D>()->SetAxisRange(0., 800,"Y");
//            Nodes[i].GetResultPtr<TH1D>()->Draw("HIST");
//        }
//        else
//        {
...
//            Nodes[i].GetResultPtr<TH1D>()->GetYaxis()->CenterTitle(true);
//            Nodes[i].GetResultPtr<TH1D>()->GetXaxis()->SetTitleOffset(1.2);
//            Nodes[i].GetResultPtr<TH1D>()->SetAxisRange(0., 1750,"Y");
//            Nodes[i].GetResultPtr<TH1D>()->Draw("HIST");
//        }
//        else
//        {
...
//            Nodes[i].GetResultPtr<TH1D>()->GetYaxis()->CenterTitle(true);
//            Nodes[i].GetResultPtr<TH1D>()->GetXaxis()->SetTitleOffset(1.2);
//            Nodes[i].GetResultPtr<TH1D>()->SetAxisRange(0., 900,"Y");
//            Nodes[i].GetResultPtr<TH1D>()->Draw("HIST");
//        }
//        else
//        {
...
//
//    TCanvas* c1 = new TCanvas();
//    TLegend* legend = new TLegend(0.4775, 0.47, 0.73, 0.75);
//
...
//
//            return Take(photon_id_eff, photons_pass_cut_indices)[mpi] * Take(photon_iso_eff, photons_pass_cut_indices)[mpi] * Take(photon_trg_eff, photons_pass_cut_indices)[mpi]; // a single number
//
...
//            Nodes[i].GetResultPtr<TH1D>()->GetYaxis()->CenterTitle(true);
//            Nodes[i].GetResultPtr<TH1D>()->GetXaxis()->SetTitleOffset(1.2);
//            Nodes[i].GetResultPtr<TH1D>()->SetAxisRange(0., 2550,"Y");
//            Nodes[i].GetResultPtr<TH1D>()->Draw("HIST");
//        }
//        else
//        {
...
//            Nodes[i].GetResultPtr<TH1D>()->GetYaxis()->CenterTitle(true);
//            Nodes[i].GetResultPtr<TH1D>()->GetXaxis()->SetTitleOffset(1.2);
//            Nodes[i].GetResultPtr<TH1D>()->SetAxisRange(0., 540,"Y");
//            Nodes[i].GetResultPtr<TH1D>()->Draw("HIST");
//        }
//        else
//        {
...
//    ROOT::RDF::RunGraphs(Nodes); // running all computation nodes concurrently
//
//    std::map<float, int> unique_vals_1, unique_vals_0p01, unique_vals_0p001;
...
void SignalShapes()
{
    ...
    TLegend* legend;
    TLatex Tl;
    std::vector<float> massPoints = {1, 3, 5};
    std::vector<ROOT::RDF::RResultHandle> Nodes;
    int count = 0;
...
//    9  10  11   //1, 3, 5 GeV for Cayy=0.001
    ...
    constexpr std::array<int,3> massVals = {1, 3, 5};
    ...
    //Displaced Samples
    constexpr std::array<const char*, 3> legendLabels = {" (C_{a#gamma#gamma} = 1)", " (C_{a#gamma#gamma} = 0.01)", " (C_{a#gamma#gamma} = 0.001)"};
    constexpr std::array<const char*, 3> fileNames = {"Axion_masses_Cayy_1.pdf", "Axion_masses_Cayy_0p01.pdf", "Axion_masses_Cayy_0p001.pdf"};
    constexpr std::array<float, 3> maxima = {130, 1700, 1400};

    for (int i = 3, k = 0; i <= 9; i += 3, k++)
    {
        c1 = new TCanvas();
...
//    9  10  11   //1, 3, 5 GeV for Cayy=0.001
    ...
    //Displaced Samples
    constexpr std::array<const char*, 3> legendLabels = {"  (C_{a#gamma#gamma} = 1)", "  (C_{a#gamma#gamma} = 0.01)", "  (C_{a#gamma#gamma} = 0.001)"};
    constexpr std::array<const char*, 3> fileNames = {"DeltaR_Cayy_1.pdf", "DeltaR_Cayy_0p01.pdf", "DeltaR_Cayy_0p001.pdf"};
